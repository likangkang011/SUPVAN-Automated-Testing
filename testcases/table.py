...
driver.find_element(By.XPATH,'//android.widget.ImageView[@resource-id="com.fhit.app_iprinter:id/my_activity_main_lp_enter_right_iv"]').click()
#点击表格
driver.find_element(By.XPATH,'//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text="表格"]').click()
#打印当前页面尺寸
...
time.sleep(2)
driver.find_element(By.ID,"com.fhit.app_iprinter:id/window_table_edit").send_keys("表格1")
#输入表格二的信息
driver.swipe(screen_width*0.67,screen_height*0.29,screen_width*0.66,screen_height*0.29)
driver.find_element(By.XPATH,'//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/tvText" and @text="属性"]').click()
time.sleep(2)
driver.find_element(By.ID,"com.fhit.app_iprinter:id/window_table_edit").send_keys("表格2")
driver.find_element(By.ID,"com.fhit.app_iprinter:id/dialog_table_iv_affirm").click()
print("已完成")
time.sleep(2)

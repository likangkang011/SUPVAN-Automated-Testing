...
# 创建 Options 对象并设置 capabilities
    ...
    #点击一维码
    driver.find_element(By.XPATH,'//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text="一维码"]').click()
    time.sleep(1)
    #定位输入框并输入

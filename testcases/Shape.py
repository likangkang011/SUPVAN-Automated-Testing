...
# 点击形状
driver.find_element(By.XPATH, '//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text="形状"]').click()
time.sleep(1)

# 添加一个形状,默认添加五角星，需要添加其他形状修改下标
driver.find_element(By.XPATH, '(//android.widget.ImageView[@resource-id="com.fhit.app_iprinter:id/ivShape"])[1]').click()
time.sleep(3)

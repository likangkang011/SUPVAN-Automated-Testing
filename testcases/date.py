...
#切换下一页功能(7次）
    ...
    driver.find_element(By.XPATH,'//android.widget.ImageView[@resource-id="com.fhit.app_iprinter:id/my_activity_main_lp_enter_right_iv"]').click()
#点击日期功能
    driver.find_element(By.XPATH,'//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text="日期"]').click()
#打开实时时间
...
#打开添加关联时间
    driver.find_element(By.ID,"com.fhit.app_iprinter:id/sAddAssociation").click()
#点击确定

...
# 点击边框
driver.find_element(By.XPATH,  '(//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text=\'边框\'])[1]').click()

# 添加一个边框,默认添加细直角边框，需要添加其他边框修改下标
driver.find_element(By.XPATH, '(//android.widget.ImageView[@resource-id="com.fhit.app_iprinter:id/ivBorder"])[1]').click()
time.sleep(3)

...
driver.find_element(
    By.XPATH,
    '//android.widget.TextView[@resource-id="com.fhit.app_iprinter:id/item_adapter_lp_custom_horizontal_scroll_view_tv" and @text="端子/端口"]').click()
# 改变端子方向为竖向
...
driver.find_element(
    By.XPATH,
    '(//android.widget.EditText[@resource-id="com.fhit.app_iprinter:id/adapter_terminal_block_content"])[1]').send_keys("测试1")
# 输入端子内容2
driver.find_element(
    By.XPATH,
    '(//android.widget.EditText[@resource-id="com.fhit.app_iprinter:id/adapter_terminal_block_content"])[2]').send_keys("测试2")
# 关闭端子端口页面
driver.find_element(
    By.ID,
